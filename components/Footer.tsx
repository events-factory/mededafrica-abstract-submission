      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-3">
            <a
              href="https://www.facebook.com/ughe.org"
              target="_blank"
            ...
            <a
              href="https://x.com/ughe_org?s=21"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-primary-500 hover:bg-primary-600 text-white rounded flex items-center justify-center transition-colors"
              aria-label="X"
            ...
            <a
              href="https://www.instagram.com/ughe_org"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-primary-500 hover:bg-primary-600 text-white rounded flex items-center justify-center transition-colors"
            ...
            <a
              href="https://www.linkedin.com/school/ughe/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-primary-500 hover:bg-primary-600 text-white rounded flex items-center justify-center transition-colors"
              aria-label="LinkedIn"
          ...
          <div className="text-right text-sm text-gray-600">
            ...
            <p>Kigali Heights | 4th Floor, KG 7 Ave</p>
            <p>P.O. Box 3456, Kigali, Rwanda</p>
          </div>
        </div>
        ...
        <div className="mt-6 pt-6 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-600">
          ...
          <div>© 2026 MedEd Africa. All rights reserved.</div>
        </div>
      </div>
    </footer>
  );
